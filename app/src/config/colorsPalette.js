...
export const getRandomColor = (alpha) => {
    const maxValue = colorsPalette.length
    const colorIndex = Math.trunc(Math.random() * maxValue)
    const colorCode = colorsPalette[colorIndex]
    return hexToRgba(colorCode, alpha)
}
